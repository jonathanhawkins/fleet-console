...
import { envelope, stripScales } from "./joint-spec";
 ...
 * not render React.** Eighteen of these are mounted at once and the store
 * commits ten times a second; if a strip ever picks up a reactive subscription
 * — a `useFleetStore(...)` added for convenience, a piece of state lifted for
 * a tooltip — the page quietly starts re-rendering 180 times a second and
 * nothing fails except the frame budget. The counter below is the tripwire,
 * same technique as fleet-rail.test.tsx.
 */
