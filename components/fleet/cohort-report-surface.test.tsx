...
describe("the times", () => {
  ...
  // The missing-moment dash is the shared shell's; see incident-report-surface.test.tsx.
...
describe("the document's frame", () => {
  // Footer, focus trap, and print-hidden controls are the shared shell's own;
  // covered once in incident-report-surface.test.tsx "the document's frame".
